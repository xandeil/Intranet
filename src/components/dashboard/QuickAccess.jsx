...
import { 
  ...
  Activity // Adicionado para o Monitoramento
} from 'lucide-react';
import { quickAccessItems } from '../../data/mockData.js';
import Card from '../ui/Card';

// Mapeie o ícone Activity aqui para ele aparecer no card 10
const iconMap = {
  Calendar, Image, Newspaper, Users, Database, Package, Monitor, Shield, Gift, Activity
};
